...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Moderné webstránky na mieru od Experta. Rýchly vývoj už za 3–7 dní. Rýchle, výkonné a cenovo dostupné weby pre moderné podnikanie." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Patrik Patoraj" },
      { property: "og:description", content: "Moderné webstránky na mieru od Experta. Rýchly vývoj už za 3–7 dní. Rýchle, výkonné a cenovo dostupné weby pre moderné podnikanie." },
