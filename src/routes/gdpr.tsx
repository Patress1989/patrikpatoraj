      ...
      <main className="pt-32 pb-20">
        <div className="mx-auto max-w-3xl px-6">
          ...
          <div className="mt-8 space-y-6 text-muted-foreground">
            <p className="text-base">Účinné od: 21. apríla 2026</p>

            <section className="glass rounded-2xl p-6">
              <h2 className="text-xl font-semibold text-foreground">1. Kto sme?</h2>
            ...
            <section className="glass rounded-2xl p-6">
              <h2 className="text-xl font-semibold text-foreground">2. Aké údaje spracúvame a prečo?</h2>
            ...
            <section className="glass rounded-2xl p-6">
              <h2 className="text-xl font-semibold text-foreground">3. Kto nám pomáha so spracovaním (Sprostredkovatelia)?</h2>
              <p className="mt-3 text-base leading-relaxed">
            ...
            <section className="glass rounded-2xl p-6">
              <h2 className="text-xl font-semibold text-foreground">4. Súbory Cookies</h2>
              <p className="mt-3 text-base leading-relaxed">
            ...
            <section className="glass rounded-2xl p-6">
              <h2 className="text-xl font-semibold text-foreground">5. Vaše práva</h2>
              <p className="mt-3 text-base leading-relaxed">
